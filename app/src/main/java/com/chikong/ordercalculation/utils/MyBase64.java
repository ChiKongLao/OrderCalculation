...
public class MyBase64 {
	...
	/**
	 * Set up the base 64 decoding table
	 */
	...
	/**
	 * Set up the base 64 encoding table
	 */
	...
	/**
	 * Decode the base 64 encoded bytes to a byte array
	 *
	...
	/**
	 * Encode the input data into a base 64 encoded byte array
	 *
	 * @return Byte array
	 */
